<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchPage.aspx.cs" Inherits="MusicConnect.Views.SearchPage" %>
            ...
            <div id="page-wrapper">
                ...
                <div class="col-lg-10">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>Search Results: "<asp:Label ID="lblSearchResult" runat="server" Text="" CssClass="control-label"></asp:Label>"</legend>
