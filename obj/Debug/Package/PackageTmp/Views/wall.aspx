<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wall.aspx.cs" Inherits="MusicConnect.Views.profile" %>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    ...
                                                    <br />
                                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label for="timestamp" style="color: GrayText;font-weight:100; font-size: smaller">Updated on <i class="fa fa-clock-o"></i>&nbsp<%#Eval("createtime") %></label></div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    ...
                                                    <br />
                                                    <label for="genre" style="color: GrayText;font-weight:100; font-size: smaller">Genre:&nbsp<%#Eval("musicgenre") %></label><br /></div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-6">
