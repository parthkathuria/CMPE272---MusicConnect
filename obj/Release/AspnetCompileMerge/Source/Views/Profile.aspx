<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="MusicConnect.Views.Profile" %>
            ...
            <div id="page-wrapper">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="col-lg-3">
                            <fieldset>
                                <asp:Image ID="impPic" runat="server" Width="200" Height="200" />
                                <br />
                    ...
                    <div class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group" style="text-align: right">
                                <div class="col-lg-12">
                                    <asp:LinkButton ID="lnkEditProfile" CssClass="btn btn-default" runat="server" OnClick="lnkEditProfile_Click"><i class="fa fa-pencil"></i>&nbsp Edit Profile</asp:LinkButton>
                                </div>
                            </div>
