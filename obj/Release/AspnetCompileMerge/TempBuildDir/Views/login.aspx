                    ...
                    <div class="form-horizontal" id="RegistrationForm">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <asp:TextBox CssClass="form-control" ID="inputFname" runat="server" placeholder="First Name"></asp:TextBox>
                                </div>
                                <div class="col-lg-5">
                                    <asp:TextBox CssClass="form-control" ID="inputLname" runat="server" placeholder="Last Name"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <asp:TextBox ID="dateOfBirth" CssClass="form-control" runat="server" placeholder="Date of Birth"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <asp:TextBox ID="inputEmail" runat="server" CssClass="form-control" OnTextChanged="inputEmail_TextChanged" AutoPostBack="True" placeholder="Email ID"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <asp:TextBox ID="inputPassword" runat="server" CssClass="form-control" TextMode="Password" placeholder="Password"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-2">
                                    <asp:Button ID="registerButton" runat="server" Text="Register" CssClass="btn btn-primary" OnClick="registerButton_Click" OnClientClick="return frm_register();" />
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-lg-10 col-lg-offset-3">
                                    <asp:Button ID="LoginButton" runat="server" Text="Login" CssClass="btn btn-primary" OnClick="LoginButton_Click" OnClientClick="return chk_login()" />
