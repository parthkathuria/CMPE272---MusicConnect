<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Following.aspx.cs" Inherits="MusicConnect.Views.Following" %>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                       <li class=""><a href="wall.aspx"><i class="fa fa-headphones"></i>&nbsp Music Wall</a></li>
                        ...
                        <li class="active"><a href="Following.aspx"><i class="fa fa-group"></i>&nbsp Following</a></li>
